...
const CURRENT_CACHE = "ostadh-lahooni-v107-academic-identity";
const RELOAD_KEY = "ostadh-lahooni-v107-academic-identity";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=107-academic-identity", {
          scope: "/",
          updateViaCache: "none",
        });
