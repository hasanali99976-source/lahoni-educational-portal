...
const CURRENT_CACHE = "ostadh-lahooni-v95-grade-plan-direct";
const RELOAD_KEY = "ostadh-lahooni-v95-grade-plan-direct";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=95-grade-plan-direct", {
          scope: "/",
          updateViaCache: "none",
        });
