...
const CURRENT_CACHE = "ostadh-lahooni-v106-official-entry";
const RELOAD_KEY = "ostadh-lahooni-v106-official-entry";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=106-official-entry", {
          scope: "/",
          updateViaCache: "none",
        });
