...
const CURRENT_CACHE = "ostadh-lahooni-v88-no-evaluation-plans";
const RELOAD_KEY = "ostadh-lahooni-v88-no-evaluation-plans-reloaded";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=88-no-evaluation-plans", {
          scope: "/",
          updateViaCache: "none",
        });
