...
const CURRENT_CACHE = "ostadh-lahooni-v100-diagnostic-full-pdf";
const RELOAD_KEY = "ostadh-lahooni-v100-diagnostic-full-pdf";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=100-diagnostic-full-pdf", {
          scope: "/",
          updateViaCache: "none",
        });
