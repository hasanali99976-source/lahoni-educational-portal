...
const CURRENT_CACHE = "ostadh-lahooni-v105-centered-entry";
const RELOAD_KEY = "ostadh-lahooni-v105-centered-entry";
  ...
  useEffect(() => {
    ...
    const register = async () => {
      try {
        ...
        registration = await navigator.serviceWorker.register("/sw.js?v=105-centered-entry", {
          scope: "/",
          updateViaCache: "none",
        });
