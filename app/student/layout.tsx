...
import "./student-premium-v1000.css";
import "./student-premium-fixes-v1001.css";
...
import StudentPremiumRuntime from "./student-premium-runtime";

export default function StudentLayout({ children }: { children: React.ReactNode }) {
  return <><StudentQrLock /><StudentReportSessionGuard /><StudentReportPdfV2Runtime /><StudentUiCleanupRuntime /><StudentAcademicRuntime /><StudentPremiumRuntime />{children}</>;
}
