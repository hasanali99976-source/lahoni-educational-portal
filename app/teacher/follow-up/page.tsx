...
export default function FollowUpPage() {
  ...
  function printMasteryTable() {
    ...
    win.document.write(`<!doctype html><html lang="ar" dir="rtl"><head><meta charset="utf-8"><title>تقرير الإتقان</title><style>@page{size:A4 portrait;margin:7mm}*{box-sizing:border-box}body{margin:0;font-family:Arial,Tahoma,sans-serif;color:#18344f;background:#fff}.sheet{position:relative;min-height:270mm;padding-bottom:10mm;break-inside:avoid;page-break-inside:avoid}.new-page{page-break-before:always}header{display:flex;justify-content:space-between;align-items:center;border:1px solid #cbdbea;border-top:4px solid #1768c5;padding:7px 10px}header small{color:#1768c5;font-weight:700}header h1{margin:2px 0;font-size:18px;color:#123f70}header p{margin:0;color:#63798d;font-size:11px}header>strong{background:#1768c5;color:#fff;border-radius:9px;padding:9px 13px}.meta{display:grid;grid-template-columns:repeat(4,1fr);gap:5px;margin:5px 0}.meta span{border:1px solid #dbe6ef;background:#f6f9fc;border-radius:7px;padding:8px;font-size:10.5px}table{width:100%;border-collapse:collapse;font-size:8.5px}th,td{border:1px solid #cbd9e6;padding:4px 4px;text-align:center}th{background:#1768c5;color:#fff}td:nth-child(2){text-align:right;font-weight:700}tbody tr:nth-child(even){background:#f5f9fd}.empty-print{padding:25px;color:#708397}footer{margin-top:8px;right:0;left:0;display:flex;justify-content:space-between;border-top:1px solid #d8e3ed;padding-top:8px;color:#6d8295;font-size:9px}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}</style></head><body>${pages}</body></html>`);
