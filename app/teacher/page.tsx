...
export default function TeacherLoginPage(){
 ...
 return <main className="portal-entry-page teacher-entry-page" dir="rtl"><div className="portal-entry-shell">
   ...
   <section className="portal-entry-hero">
    <div className="portal-entry-copy"><span className="portal-entry-kicker">مساحة العمل الأكاديمية</span><h1>بوابة المعلم</h1><p>الحضور، الجدول، التحصيل والمتابعة في مساحة واحدة متصلة بهوية البوابة الرئيسية.</p></div>
