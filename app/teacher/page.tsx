...
export default function TeacherLoginPage(){
 ...
 return <main className="portal-entry-page teacher-entry-page" dir="rtl"><div className="portal-entry-shell">
   ...
   <section className="portal-entry-hero">
    <div className="portal-entry-copy"><span className="portal-entry-kicker">مساحة العمل الأكاديمية</span><h1>بوابة المعلم</h1><p>الحضور، الجدول، التحصيل والمتابعة في مساحة واحدة متصلة بهوية البوابة الرئيسية.</p><div className="teacher-entry-tabs teacher-entry-tabs-large" aria-label="خدمات بوابة المعلم"><span><b>الحضور والمتابعة</b><small>رصد يومي مباشر</small></span><span><b>الجدول الدراسي</b><small>الحصص الأسبوعية</small></span><span><b>التحضير</b><small>تحضير الدروس</small></span><span><b>التحصيل العلمي</b><small>الدرجات والرصد</small></span><span><b>إدارة الفصول</b><small>طلابك وفصولك</small></span><span><b>التقارير</b><small>متابعة وطباعة</small></span></div></div>
