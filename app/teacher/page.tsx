...
export default function TeacherLoginPage(){
  ...
  return <main className="teacher-login-current" dir="rtl">
    ...
    <section className="tlc-stage">
      <section className="tlc-intro">
        <div className="tlc-badge">بوابة المعلم</div>
        ...
        <div className="tlc-strip"><i/><span>بيئة عمل موحدة لجميع مواد المعلم</span><b>جاهزة للاستخدام</b></div>
      </section>
      ...
      <section className="tlc-card">
        ...
        <div className="tlc-trust"><span>نفس بياناتك الحالية</span><span>لا تغيير على حسابك</span></div>
      </section>
    </section>
