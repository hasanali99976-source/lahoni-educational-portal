...
@media print {
  ...
  .print-student-table, .print-student-table * { visibility: visible !important; }\n  .print-report-head { display: block !important; text-align: center !important; margin: 0 0 8mm !important; padding: 6mm !important; border: 1px solid #b7c9df !important; border-radius: 12px !important; background: linear-gradient(135deg,#eaf3ff,#f7fbff) !important; color: #102a43 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }\n  .print-brand { display:flex !important; align-items:center !important; justify-content:center !important; gap:3mm !important; margin-bottom:4mm !important; }\n  .print-brand > div { display:block !important; text-align:right !important; }\n  .print-brand strong { display:block !important; font-size:12pt !important; color:#123b69 !important; }\n  .print-brand small { display:block !important; font-size:8.5pt !important; color:#52708f !important; }\n  .print-mark { display:grid !important; place-items:center !important; width:11mm !important; height:11mm !important; border-radius:50% !important; background:#123b69 !important; color:#fff !important; font-size:17pt !important; font-weight:900 !important; }\n  .print-report-head h1 { margin: 0 0 4mm !important; font-size: 20pt !important; }\n  .print-report-head .print-meta { display: flex !important; justify-content: center !important; gap: 6mm !important; font-size: 10pt !important; }\n  .print-meta > * { padding:2.5mm 5mm !important; border-radius:999px !important; background:#fff !important; border:1px solid #cbd9e8 !important; color:#173b63 !important; }
  ...
  .print-student-table th, .print-student-table td { border: 1px solid #777 !important; padding: 6px 5px !important; background: #fff !important; color: #18324a !important; text-align: center !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; vertical-align: middle !important; }
  @page { size: A4 landscape; margin: 12mm; }\n  .print-student-table thead { display: table-header-group !important; }\n  .print-student-table th { background:#123b69 !important; color:#fff !important; font-weight:800 !important; }\n  .print-student-table tbody tr:nth-child(even) td { background:#f1f6fb !important; }\n  .print-student-table .table-caption { border:1px solid #d7e2ee !important; background:#eef5fc !important; padding:4mm !important; margin-bottom:3mm !important; color:#173b63 !important; -webkit-print-color-adjust:exact !important; print-color-adjust:exact !important; }\n  .print-student-table tr { break-inside: avoid !important; page-break-inside: avoid !important; }\n  .print-student-table .name { text-align: right !important; font-weight: 700 !important; }
}`}</style>
  </section>;
}
