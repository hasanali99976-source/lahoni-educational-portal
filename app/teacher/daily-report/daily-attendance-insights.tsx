...
@media print {
  ...
  .print-student-table { position:absolute !important; top:0 !important; right:0 !important; width:100% !important; margin:0 !important; padding:0 !important; border:0 !important; box-shadow:none !important; background:#fff !important; }
  .print-sheet { width:100% !important; min-height:0 !important; box-sizing:border-box !important; border:2px solid #173f70 !important; border-radius:14px !important; overflow:hidden !important; background:#fff !important; -webkit-print-color-adjust:exact !important; print-color-adjust:exact !important; }
  .print-report-head { display:block !important; text-align:center !important; margin:0 !important; padding:4mm 5mm 3.5mm !important; background:linear-gradient(135deg,#0c315d,#1765a7) !important; color:#fff !important; }
  .print-brand { display:flex !important; align-items:center !important; justify-content:center !important; gap:2.5mm !important; margin-bottom:2mm !important; }
  .print-brand > div { display:block !important; text-align:right !important; }
  .print-brand strong { display:block !important; font-size:11pt !important; color:#fff !important; }
  .print-brand small { display:block !important; font-size:7.5pt !important; color:#dcecff !important; }
  .print-mark { display:grid !important; place-items:center !important; width:9mm !important; height:9mm !important; border-radius:50% !important; background:#fff !important; color:#124d83 !important; font-size:14pt !important; font-weight:900 !important; }
  .print-report-head h1 { margin:1mm 0 2mm !important; font-size:17pt !important; color:#fff !important; }
  .print-report-head .print-meta { display:flex !important; justify-content:center !important; gap:3mm !important; font-size:8.5pt !important; }
  .print-meta > * { padding:1.5mm 3.5mm !important; border-radius:999px !important; background:#fff !important; border:1px solid #b9d6ef !important; color:#123b69 !important; }
  .print-student-table .table-caption { display:flex !important; justify-content:space-between !important; align-items:center !important; margin:0 !important; padding:2.5mm 4mm !important; background:#eaf4fc !important; color:#173b63 !important; border:0 !important; border-bottom:1px solid #c7dbea !important; }
  .print-student-table .table-caption b { font-size:10pt !important; }
  .print-student-table .table-caption span, .print-student-table .table-caption small { font-size:8pt !important; }
  .print-student-table table { width:100% !important; border-collapse:collapse !important; font-size:8.2pt !important; direction:rtl !important; table-layout:fixed !important; }
  .print-student-table thead { display:table-header-group !important; }
  .print-student-table th { background:#174f83 !important; color:#fff !important; font-weight:800 !important; padding:2.1mm 1.5mm !important; border:1px solid #326993 !important; }
  .print-student-table td { padding:1.75mm 1.5mm !important; border:1px solid #d4e0ea !important; color:#18324a !important; text-align:center !important; background:#fff !important; line-height:1.15 !important; }
  .print-student-table tbody tr:nth-child(even) td { background:#eef6fc !important; }
  .print-student-table tr { break-inside:avoid !important; page-break-inside:avoid !important; }
  .print-student-table .name { text-align:right !important; font-weight:800 !important; }
  .print-footer { display:flex !important; justify-content:space-between !important; padding:2mm 4mm !important; background:#0c315d !important; color:#fff !important; font-size:7.5pt !important; }
