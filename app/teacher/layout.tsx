...
const sideTabs: TeacherTab[] = [
  { href: "/teacher/dashboard", key: "dashboard", label: "الرئيسية", note: "مركز العمل اليومي" },
