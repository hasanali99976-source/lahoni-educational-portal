...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ar" dir="rtl"><head><link rel="stylesheet" href="/teacher-prepaint-v115.css?v=116" /><link rel="stylesheet" href="/teacher-mobile-critical-v113.css?v=116" /></head><body className={academyFont.className}>
