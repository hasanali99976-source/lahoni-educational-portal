...
import SharedSourceSync from "./shared-source-sync";
...
export const metadata:Metadata={
  ...
  manifest:"/manifest.webmanifest?v=2026-mobile-v126",
  appleWebApp:{capable:true,title:"أستاذ لحوني",statusBarStyle:"default"},
  formatDetection:{telephone:false},
  icons:{icon:[{url:"/icon.svg?v=2026-mobile-v126",type:"image/svg+xml"},{url:"/icons/lahooni-identity-320.jpg?v=2026-mobile-v126",sizes:"320x320",type:"image/jpeg"}],apple:[{url:"/icons/lahooni-identity-320.jpg?v=2026-mobile-v126",sizes:"320x320",type:"image/jpeg"}]}
};
...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="ar" dir="rtl"><body className={tajawal.className}><PwaRegister/><MobileAppEnhancer/><SharedSourceSync/>{children}</body></html>;
}
