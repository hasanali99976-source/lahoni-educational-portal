...
type IconName = "home" | "students" | "attendance" | "grades" | "plans" | "tests" | "ai" | "admin" | "back";
...
function AppIcon({ name }: { name: IconName }) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    plans: <><rect x="4" y="4" width="16" height="16" rx="2.5"/><path d="M8 2.8v3M16 2.8v3M7.5 9.5h9M8 13h3M14 13h2M8 16.5h5"/></>,
...
export default function MobileAppEnhancer() {
  ...
  const links = useMemo<MobileLink[]>(() => {
    if (pathname.startsWith("/teacher")) return [
      ...
      { href: "/teacher/evaluation-plans", label: "الخطط", icon: "plans" },
