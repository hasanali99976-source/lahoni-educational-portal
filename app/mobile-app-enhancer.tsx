...
export default function MobileAppEnhancer() {
  ...
  return <>
    ...
    {!standalone && installPrompt && !dismissed && <div className="mobile-install-card" dir="rtl">
      ...
      <button type="button" onClick={install}>تثبيت</button>
      <button type="button" className="mobile-install-close" onClick={dismissInstall} aria-label="إغلاق">×</button>
    </div>}
  </>;
}
